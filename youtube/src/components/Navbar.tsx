    ...
    <div className="flex justify-between items-center px-14 h-14 bg-[#212121] opacity-95 sticky top-0 z-50">
      ...
      <div className="flex gap-5 items-center text-xl">
        ...
        <div className="relative">
          <BsBell />
          <span className="absolute  left-4 bottom-3 text-xs bg-red-600 rounded-full px-1">
            9+
          </span>
        </div>
        <img
          src="https://tse1.mm.bing.net/th?id=OIP.lDntOG-M-pSTeQY5FsKaAAHaEo&pid=Api&rs=1&c=1&qlt=95&w=189&h=118"
          alt="logo"
